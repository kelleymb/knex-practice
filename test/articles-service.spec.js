...
describe(`Articles service object`, function() {
    ...
    const testArticles = [
        ...
        context(`Given 'blogful_articles' has data`, () => {
            ...
            //We can add a test for getting a specific article by ID now, 
        //we'll call the method getById.
...
describe(`Articles service object`, function() {
    ...
    context(`Given 'blogful_articles' has no data`, () => {
        ...
        it(`insertArticle() inserts a new article and resolves the new article with an 'id'`, () => {
            //new article to use as subject for test
            const newArticle = {
            ...
            return ArticlesService.insertArticle(db, newArticle)
                //Update the test to assert that the method resolves the 
                //newly created article with an incremented ID. 
